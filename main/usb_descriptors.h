...
#define TUD_AUDIO_DESC_FEATURE_UNIT_8_CHANNEL_LEN (6+(8+1)*4)
#define TUD_AUDIO_DESC_FEATURE_UNIT_8_CHANNEL(_unitid, _srcid, _ctrlch0master, _ctrlch, _stridx) \
    TUD_AUDIO_DESC_FEATURE_UNIT_8_CHANNEL_LEN, TUSB_DESC_CS_INTERFACE, AUDIO_CS_AC_INTERFACE_FEATURE_UNIT, _unitid, _srcid, U32_TO_U8S_LE(_ctrlch0master),\
    U32_TO_U8S_LE(_ctrlch), U32_TO_U8S_LE(_ctrlch), U32_TO_U8S_LE(_ctrlch), U32_TO_U8S_LE(_ctrlch),\
    U32_TO_U8S_LE(_ctrlch), U32_TO_U8S_LE(_ctrlch), U32_TO_U8S_LE(_ctrlch), U32_TO_U8S_LE(_ctrlch), _stridx
...
#define TUD_AUDIO_CONVERTER_DESC_LEN (TUD_AUDIO_DESC_IAD_LEN\
    ...
    + TUD_AUDIO_DESC_FEATURE_UNIT_8_CHANNEL_LEN\
...
#define TUD_AUDIO_CONVERTER_DESCRIPTOR(_stridx, _epout) \
    ...
    TUD_AUDIO_DESC_CS_AC(/*_bcdADC*/ 0x0200, /*_category*/ AUDIO_FUNC_CONVERTER, /*_totallen*/ TUD_AUDIO_DESC_CLK_SRC_LEN+TUD_AUDIO_DESC_FEATURE_UNIT_8_CHANNEL_LEN+TUD_AUDIO_DESC_INPUT_TERM_LEN+TUD_AUDIO_DESC_OUTPUT_TERM_LEN, /*_ctrl*/ AUDIO_CS_AS_INTERFACE_CTRL_LATENCY_POS),\
    ...
    TUD_AUDIO_DESC_FEATURE_UNIT_8_CHANNEL(UAC2_ENTITY_SPK_FEATURE_UNIT, /*_srcid*/ UAC2_ENTITY_SPK_INPUT_TERMINAL, /*_ctrlch0master*/ (AUDIO_CTRL_RW << AUDIO_FEATURE_UNIT_CTRL_MUTE_POS | AUDIO_CTRL_RW << AUDIO_FEATURE_UNIT_CTRL_VOLUME_POS), /*_ctrlch*/ (AUDIO_CTRL_RW << AUDIO_FEATURE_UNIT_CTRL_MUTE_POS | AUDIO_CTRL_RW << AUDIO_FEATURE_UNIT_CTRL_VOLUME_POS), /*_stridx*/ 0x00),\
